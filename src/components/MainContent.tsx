...
function MainContent(): JSX.Element {
  ...
  return (
    <>
      ...
      <hr />
      <p>
        Showing {searchFilteredData.length} of {episodeData.length}
      </p>
